...
namespace PMS_DAL.Repository
{
    public class User_Repository
    {
        ...
        public bool Username_Check(string user)
        {
            try
            {
                User_Registration Username_Reg = DB.User_Registration.Where(u => u.User_Name == user).FirstOrDefault();
        ...
        public bool UserEmail_Check(string email)
        {
            try
            {
                User_Registration UserEmail_Reg = DB.User_Registration.Where(u => u.User_Email_Id == email).FirstOrDefault();
                if (UserEmail_Reg != null)
                {
                    return false;
                }
                else
